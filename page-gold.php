                        ...
                        <div class="rateGraph__inner--select form__wrap">
                            <div class="price-chart-header form__liner">
                                <select id="graph-select" class="form-control my-5">
                                    ...
                                    <optgroup label="gold">
                                        <option value="k24_ingot" selected="selected">Emas batangan</option>
                            ...
                            <p id="price-chart-legend" class="chart-legend">Emas batangan (S$/g)</p>
                        </div>
                        <div class="flex flex--hasItem6">
                            <ul class="flex__tab">
                                <li class="tab__item active"><a>1 bulan</a></li>
                                <li class="tab__item "><a>3 bulan</a></li>
                                <li class="tab__item "><a>6 bulan</a></li>
                                <li class="tab__item "><a>1 tahun</a></li>
                                <li class="tab__item "><a>3 tahun</a></li>
                                <li class="tab__item "><a>10 tahun</a></li>
                                <li class="tab__item "><a>20 tahun</a></li>
                                <li class="tab__item "><a>30 tahun</a></li>
                                <li class="tab__item "><a>seluruh durasi</a></li>
                            </ul>
