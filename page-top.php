...
<body id="mock_app">
    ...
    <div class="fv_img_wrap">
        <img class="is-pc" src="images/index/OTAKARAYA_top_PC_EN.webp" alt="Pembelian harga tinggi di Otakaraya">
        <img class="is-sp" src="images/index/OTAKARAYA_top_SP_EN.webp" alt="Pembelian harga tinggi di Otakaraya">
    </div>
    ...
    <main class="contents">
        <article class="contents__left">
            ...
            <div class="cta_band_img_area">
                <img class="is-pc" style="width: 100%;" src="images/index/Now_is_the_time_to_sell_if_you're_unsure_PC.webp" alt="Sekarang saatnya untuk menjual">
                <img class="is-sp" style="width: 100%;" src="images/index/Now_is_the_time_to_sell_if_you're_unsure_SP.webp" alt="Sekarang saatnya untuk menjual">
            </div>
            <!-- ctaセクション -->
