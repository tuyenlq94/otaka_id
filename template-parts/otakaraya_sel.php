<div class="titleMain titleMain--wrapper">
    ...
    Kami dapat dengan mudah menilai item Anda!
    </h2>
...
<div class="reason_section_content">
    <div class="content_area">
        <div class="reason_section_content_wrap">
            <div class="reason_area_img_wrap" style="position: relative;">
                <span class="reason_numbering" style="position: absolute; left: 0px;">
                    01
                </span>
            ...
            <div class="reason_area_img_wrap" style="position: relative;">
                ...
                <div class="reason_section_text_area">
                    <p class="reason_section_ttl">
                    Lingkungan penilaian terbaik
                    </p>
                    <p class="reason_section_text">
                    Kami dapat menentukan nilai sebenarnya dari item Anda dan menawarkan Anda harga yang wajar!
                    </p>
                </div>
            </div>
            <div class="reason_area_img_wrap" style="position: relative;">
            ...
            <div class="reason_area_img_wrap" style="position: relative;">
                ...
                <div class="reason_section_text_area">
                    <p class="reason_section_ttl">
                    Pengurangan Biaya Melalui Lelang In-House
                    </p>
                    <p class="reason_section_text">
                    Dengan meminimalkan biaya penjualan, kami dapat menetapkan harga pembelian yang lebih tinggi!
                    </p>
                </div>
            </div>
        </div>
